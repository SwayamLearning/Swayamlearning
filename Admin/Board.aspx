<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="Board.aspx.cs" Inherits="Admin_Board" Culture="auto"
                            ...
                            <asp:GridView ID="grvSYS_Boarddetail" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                <PagerTemplate>
                                    ...
                                    <asp:ImageButton Text="Previous" CommandName="Page" CommandArgument="Prev" runat="server"
                                        ImageUrl="~/App_Themes/Responsive/web/previous.png" ID="ibtnPrevious" ToolTip="Move Previous Page" Height="30px"
