<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="Subject.aspx.cs" Inherits="Admin_Subject" Culture="auto"
        ...
        <div class="row">
            <div class="col-100 scrollgridx">
                <asp:UpdatePanel ID="upDetails" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grvSYS_Subjectdetail" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"
