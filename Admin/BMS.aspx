<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="BMS.aspx.cs" Inherits="BMS" Culture="auto" meta:resourcekey="PageResource2"
    UICulture="auto" %>
                    ...
                    <fieldset id="fsEmpStdSubEdit" runat="server" style="margin: 5px">
                        ...
                        <table class="tblControl1">
                            ...
                            <tr>
                                ...
                                <td align="center" colspan="2">
                                    <asp:Button ID="btnUpdate" ValidationGroup="aEdit" runat="server" 
        ...
        <div class="row">
            <div class="col-100 scrollgridx">
                <asp:UpdatePanel ID="upDetails" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grvSYS_BMSdetail" runat="server" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"
                            ...
                            <PagerTemplate>
                                <asp:ImageButton Text="First" CommandName="Page" CommandArgument="First" runat="server" Height="30px"
                                    ImageUrl="~/App_Themes/Responsive/web/first.png" ID="ibtnFirst" ToolTip="Move First Page" 
                                    meta:resourcekey="ibtnFirstResource1" />
                                <asp:ImageButton Text="Previous" CommandName="Page" CommandArgument="Prev" runat="server" Height="30px"
                                ...
                                <asp:ImageButton Text="Next" CommandName="Page" CommandArgument="Next" runat="server" Height="30px"
                                    ImageUrl="~/App_Themes/Responsive/web/NEXT.png" ID="ibtnNext" ToolTip="Move Next Page"
                                    meta:resourcekey="ibtnNextResource1" />
                                <asp:ImageButton Text="Last" CommandName="Page" CommandArgument="Last" runat="server" Height="30px"
