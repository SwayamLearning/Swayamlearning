<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ClassRoomTrackRPT.aspx.cs" Inherits="Admin_ClassRoomTrackRPT"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row" style="background: #72abb5; color: White; height: 50px;">
            <div class="col-100">
                <asp:Label ID="lblTitle" runat="server" Text="Class room wise track report" meta:resourcekey="lblTitleResource1"></asp:Label>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
                ...
                <asp:RequiredFieldValidator ID="RFVddlSchool" runat="server" ControlToValidate="ddlSchool"
                    InitialValue="-- Select --" ErrorMessage="Please Select School." ValidationGroup="PnlBMS"
        ...
        <div class="row">
            <div class="col-25">
                <asp:Label ID="lblFdate" runat="server" Text="Activity Date :" meta:resourcekey="lblFdateResource1"></asp:Label>
            </div>
            <div class="col-75">
                <asp:TextBox ID="txtFdate" runat="server" Width="200px" meta:resourcekey="txtFdateResource1"></asp:TextBox>
        ...
        <div class="row">
            ...
            &nbsp;
                ...
                <asp:Button ID="btnReset" Text="Reset" runat="server" CssClass="gobutton" OnClick="btnReset_Click"
                            ...
                            <div id="dataDiv" runat="server" visible="false">
                                <table width="100%">
                                    ...
                                    <div id="ContentDiv" runat="server">
                                        <tr>
                                            <td align="right" valign="top" width="25%">
                                                <asp:Label ID="lblActivityLogDate" runat="server" Text="Activity Log on :" meta:resourcekey="lblActivityLogDateResource1"></asp:Label>
                                            </td>
                                            <td align="left" valign="top" colspan="3" width="75%">
                                                <asp:Label ID="lblActivityLogDate1" runat="server" meta:resourcekey="lblActivityLogDate1Resource1"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" valign="top">
                                                <asp:Label ID="lblSchoolName" runat="server" Text="School Name :" meta:resourcekey="lblSchoolNameResource1"></asp:Label>
                                            </td>
                                            <td align="left" valign="top" colspan="3">
                                                <asp:Label ID="lblSchoolName1" runat="server" meta:resourcekey="lblSchoolName1Resource1"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" valign="top">
                                                <asp:Label ID="lblStd" runat="server" Text="Standard :" meta:resourcekey="lblStdResource1"></asp:Label>
                                            </td>
                                            <td align="left" valign="top">
                                                <asp:Label ID="lblStd1" runat="server" meta:resourcekey="lblStd1Resource1"></asp:Label>
                                            </td>
                                            <td align="right" valign="top">
                                                <asp:Label ID="lblDiv" runat="server" Text="Division :" meta:resourcekey="lblDivResource1"></asp:Label>
                                            </td>
                                            <td align="left" valign="top">
                                        ...
                                        <tr>
                                            <td colspan="4" align="left">
                                                <asp:GridView ID="GridReportList" runat="server" SkinID="WithoutPageSize" meta:resourcekey="GridReportListResource1">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ActivityDate" HeaderText="Activity Date" meta:resourcekey="BoundFieldResource1" />
                                                        <asp:BoundField DataField="PageName" HeaderText="Page Name" meta:resourcekey="BoundFieldResource2" />
                                                        <asp:BoundField DataField="ControlName" HeaderText="Control Name" meta:resourcekey="BoundFieldResource3" />
                                                        <asp:BoundField DataField="EventName" HeaderText="Event Name" meta:resourcekey="BoundFieldResource4" />
                                                        <asp:BoundField DataField="Activity" HeaderText="Activity" meta:resourcekey="BoundFieldResource5" />
                                                        <asp:BoundField DataField="Remark" HeaderText="Remark" meta:resourcekey="BoundFieldResource6" />
                                                        <asp:BoundField DataField="Time Difference" HeaderText="Time" meta:resourcekey="BoundFieldResource7" />
                                                        <asp:BoundField DataField="Subject" HeaderText="Subject" meta:resourcekey="BoundFieldResource8" />
                                                        <asp:BoundField DataField="Teacher Name" HeaderText="Teacher Name" meta:resourcekey="BoundFieldResource9" />
                                                    </Columns>
                                                </asp:GridView>
                                            </td>
                                        </tr>
