    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (ds_Subject == null) {
                ...
                ds_BMS = obj_BAL_SYS_Role.BAL_Select_Employee_BMS_SelectAll(Convert.ToInt64(Session["EmpolyeeID"]));

                 Session["ds_BMS"] = ds_BMS;
                //DataAccess dataAccess = new DataAccess();
                //DataTable dt = dataAccess.GetDataTable("Select * from sys_BMS");
                //ds_BMS.Tables.Add(dt);
            }
