<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="sidepanel1">
        <div class="activitydivside1">
            ...
            <div class="ActivityContent">
                <asp:GridView ID="gvLogInOutDetails" runat="server" DataKeyNames="StudentID" meta:resourcekey="gvLogInOutDetailsResource1">
                    <Columns>
                        ...
                        <asp:BoundField DataField="firstName" HeaderText="Name" meta:resourcekey="BoundFieldResource1" />
