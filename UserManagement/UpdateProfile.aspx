<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="UpdateProfile.aspx.cs" Inherits="UserManagement_UpdateProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container" style="margin-top: -50px;">
        <div class="row" style="background: #72abb5; color: White; height: 50px;">
            <div class="col-100">
                <asp:Label ID="lblAddTitle" runat="server" Text="Update Profile"></asp:Label>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
        ...
        <div class="row">
            <div class="col-25">
                <asp:Label ID="lblRoletext" runat="server" Text="Role:" Style="margin-bottom: 20px;"></asp:Label>
            </div>
            <div class="col-70">
                <asp:Label Text="text" ID="lblRole" runat="server" />
            </div>
        </div>
        <div class="row">
            <div class="col-25">
            ...
            <div class="ActivityContent">
                <div class="ActivityContent">
                    <table style="width: 100%;">
                        <%--<tr>
                <td style="text-align: right; height: 35px; padding-right: 10px;">
