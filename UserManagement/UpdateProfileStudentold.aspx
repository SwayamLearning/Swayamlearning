                ...
                <div class="card-body px-lg-5 pt-0">
                    ...
                    <div class="form-row">
                        <div class="col-xs-12 col-md-6">
                            ...
                            <asp:Label ID="lblAddFirstName" runat="server" Text="First Name" meta:resourcekey="lblAddFirstName"></asp:Label>
                    ...
                    <div class="form-row">
                        <div class="col-xs-12 col-md-6">
                            ...
                            <asp:Button ID="Txtsubmit" runat="server" Text="Submit" OnClick="btnUpdate_Click" meta:resourcekey="btnsubmit" />
