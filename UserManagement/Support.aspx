...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="row" style="width:60%; height:470px;background-color:white;margin:60px auto; ">
            ...
            <div class="col-md-9 mb-md-0 mb-5" style="margin:auto;">
                ...
                <div class="row">
                     <div class="col-md-6">
                        <div class="md-form mb-0">
                            <asp:Label ID="lblname" runat="server" Text="UserName" meta:resourcekey="lblname"></asp:Label>
                ...
                <div class="row"> 
                    <div class="col-md-12">
                        <div class="md-form mb-0">
                            <asp:Label ID="Lblsubject" runat="server" Text="How can we help" meta:resourcekey="Lblsubject"></asp:Label>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <div class="md-form mb-0" style="border:1px solid silver;min-width:100%;">
                            <asp:Label ID="LblDesc" runat="server" Text="Description" meta:resourcekey="LblDesc"></asp:Label>
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-12">
                         <asp:Button ID="btnsubmit"  CssClass="btn-blue" runat="server" Text="Submit" OnClick="btnsubmit_Click" ValidationGroup="vsupport" meta:resourcekey="btnsubmit"/>
                ...
                <div class="row">
                      ...
                      <div class="md-form mb-0" style="border:0px solid silver;min-width:100%;">
