...
public partial class NewPublic_SwayamMaster : System.Web.UI.MasterPage
{
   ...
   // {
        //string culture = cmbCulture.SelectedValue.ToString();
        ////string culture = Request.Form["cmbCulture"];
        ////HttpCookie cookie = Request.Cookies["cmbCulture"];
 ...
 //   }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ////culture = Request.Form["cmbCulture"];
        ////HttpCookie cookie = Request.Cookies["cmbCulture"];
        ////string culture = cookie.Value;
        ////culture = "gu-IN";
        ...
        if (!IsPostBack)
        {
           // cmbCulture.SelectedValue = Thread.CurrentThread.CurrentCulture.Name;
            ...
            //ddlLanguage12.Items.Insert(0, new ListItem("--Select Subject--", "0"));
            //ddlLanguage12.Items.Insert(1, new ListItem("English", "en-US"));
            //ddlLanguage12.Items.Insert(2, new ListItem("ગુજરાતી", "gu-IN"));
            //ddlLanguage12.Items.Insert(3, new ListItem("हिन्दी", "hi-IN"));
            //ddlLanguage12.SelectedIndex = 0;
    ...
    protected void cmbCulture_SelectedIndexChanged(object sender, EventArgs e)
    {
     ...
     //   Response.Cookies.Add(cookie);
        ...
        ////cmbCulture.SelectedValue = cookie.Value;

        ////string culture = Request.Form["cmbCulture"];
        ////culture = cmbCulture.SelectedValue.ToString();
        //////culture = "gu-IN";
...
//{
   //   get
       // {
            ...
            //return cmbCulture.SelectedValue;
      //  }
      //  set
     //   {
            // Set new value for control on master page  
          //  cmbCulture.SelectedValue = value;
     //   }
    }
