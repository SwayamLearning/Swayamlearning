<%@ Page Title="" Language="C#" MasterPageFile="~/NewPublic/materialMaster.master" AutoEventWireup="true" CodeFile="PackageBuy.aspx.cs" Inherits="NewPublic_PackageBuy" Culture="auto" UICulture="auto" %>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-4 lblstatic">
                                <h4>
                                    <asp:Label ID="LblPPackagenae" runat="server" Text="PackageName" meta:resourcekey="LblPPackagenaeResource1"></asp:Label></h4>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 lblstatic">
                                <h4>
                                    <asp:Label ID="lbl" runat="server" meta:resourcekey="lblResource1">Product Type</asp:Label></h4>
                            </div>
                            <div class="form-group col-md-6 lbltable">
                                <h4>
                                    <asp:Label ID="lblprod" runat="server" meta:resourcekey="lblprodResource1">Online Subscription </asp:Label>
                                </h4>
                            </div>
