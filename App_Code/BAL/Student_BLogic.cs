...
public class Student_BLogic
{
    ...
    public DataSet BAL_Verify_Teacher(Employee EMP)
    {
        DAL_Student = new DataAccess();
        arrParameter = new ArrayList();
        arrParameter.Add(new parameter("LoginID", EMP.loginid));
        return DAL_Student.DAL_Select("Proc_Verify_Employee_LoginID", arrParameter);
    }
    ...
    public DataSet BAL_Select_BMS(int BoardID, int MediumID, int StandardID)
    {
        try
        {
            ArrayList aLst = new ArrayList();
            aLst.Add(new parameter("Board", BoardID));
            aLst.Add(new parameter("MediumID", MediumID));
            aLst.Add(new parameter("StandardID", StandardID));
            return DAL_Student.DAL_Select("GetAllBMS", aLst);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    public int SetBMS(Student_BLogic paramStudent)
    {
        ArrayList aLst = new ArrayList();
        DataSet dsReturn = new DataSet();
        aLst.Add(new parameter("StudentID", paramStudent.StudentId));
        aLst.Add(new parameter("BMSid", paramStudent.BmsId));

        return DAL_Student.DAL_InsertUpdate_Return("SetBMS_By_StudentID", aLst);
    }

    public int Register_Student(Student_BLogic paramStudent)
    {
        try
        {
            ArrayList aLst = new ArrayList();
            aLst.Add(new parameter("FirstName", paramStudent.FirstName));
            aLst.Add(new parameter("EmailID", paramStudent.Email));
            return DAL_Student.DAL_InsertUpdate_Return("Student_Registration", aLst);
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    //***student profile update changed on 06-07-2020****
    public int BAL_Student_onlineUpdate(Student Student)
        {
        int t1 = 0;
        DAL_Student = new DataAccess();
        arrParameter = new ArrayList();
        ...
        if (Student.dateofbirth.ToShortDateString() == "1/1/0001")
            {
            arrParameter.Add(new parameter("DateOfBirth", DBNull.Value));
            }
        else
            arrParameter.Add(new parameter("DateOfBirth", Student.dateofbirth));
        arrParameter.Add(new parameter("Gender", Student.gender));
        ...
        t1 = DAL_Student.DAL_InsertUpdate_Return("Proc_StudentUpdate", arrParameter);
        return t1;
        // t1 =DAL_Student.DAL_InsertUpdate_return("Proc_StudentUpdate", arrParameter);
        }
    }
