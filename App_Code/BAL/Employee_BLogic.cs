...
public class Employee_BLogic
{
    ...
    public DataSet BAL_Employee_Insert_Teacher(Employee Employee)
    {
        this.DAL_Employee = new DataAccess();
        this.arrParameter = new ArrayList();
        ...
        this.arrParameter.Add(new parameter("DateOfBirth", Employee.dateofbirth));
        this.arrParameter.Add(new parameter("Address", Employee.address));
        this.arrParameter.Add(new parameter("BMSID", Employee.BMSID));
        this.arrParameter.Add(new parameter("SubjectID", Employee.SubjectID));
        return this.DAL_Employee.DAL_Select("Proc_Teacher_Insert", this.arrParameter);
    }
