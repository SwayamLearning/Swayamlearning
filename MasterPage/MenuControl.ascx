...
<asp:MultiView ID="MenuCtrl" runat="server">
        ...
        <ul id="qm0" class="qmmc11">
            ...
            <li id="li6" runat="server" style="border-right: 1px solid #000000;"><a href="#">
                ...
                <ul class="roundMenuItem">
                    ...
                    <li id="liRefund" runat="server" style="border-right: 1px solid #000000;"><a href="../Admin/RefundAmount.aspx">
        ...
        <ul id="qm1" class="qmmc11">
            ...
            <li id="liStudent" runat="server" style="border-right: 1px solid #000000;"><a href="#">
                ...
                <ul class="roundMenuItem">
                    ...
                    <li style="border-right: 1px solid #000000;"><a href="../Admission/admissiondashboard.aspx"
                        target="_self">
                        <asp:Label ID="Label17" runat="server" Text="Manage Admission"></asp:Label>
                    </a></li>
                    <li style="border-right: 1px solid #000000;"><a href="../SchoolAdmin/SendMessage.aspx"
                        target="_self">
                        <asp:Label ID="Label18" runat="server" Text="Send Message to student"></asp:Label>
                    </a></li>
                </ul>
            </li>
            ...
            <li id="li3" runat="server" style="border-right: 1px solid #000000;"><a href="#">
                ...
                <ul class="roundMenuItem" style="width: 520px;">
                    ...
                    <li style="float: right; width: 260px; position: relative;"><a href="../Report/AllSentMessageReport.aspx"
                        target="_self" style="border-right: none;">
                        <asp:Label ID="Label53" runat="server" Text="All Sent Message Report"></asp:Label>
                    </a></li>
                </ul>
            </li>
    ...
    <asp:View ID="ViewTeacher" runat="server">
        <ul id="qm2" class="qmmc11">
            ...
            <li id="li1" runat="server" style="border-right: 1px solid #000000;"><a href="#">
                <asp:Label ID="Label1" runat="server" Text="Report" meta:resourceKey="Label1"></asp:Label>
            </a>
                <ul class="roundMenuItem">
                    <li><a href="../Report/ClasswiseCoveredSyllabusNew.aspx" target="_self">
                        <asp:Label ID="Label2" runat="server" meta:resourceKey="Label2" Text="Covered Syllabus Report"></asp:Label>
                    </a></li>
                    <%--<li style="float: right; width: 260px; position: relative;"><a href="../Report/SchoolwiseStudentGenderReportNew.aspx"
                        target="_self">
    ...
    <asp:View ID="ViewStudent" runat="server">
     ...
     <div class="collapse navbar-collapse" id="myNavbar">
        <ul id="qm3" class="nav navbar-nav" >
            <li id="liStudDashboard" runat="server" ><a
            ...
            <li id="liProfile" runat="server" ><a href="../Student/StudentProfile.aspx"
                target="_self">
                <span class="glyphicon glyphicon-edit"></span>
                <asp:Label ID="lblProfile" runat="server" meta:resourceKey="lblProfile" Text="Profile"></asp:Label>
            </a></li>
            <li id="liStudentPackage" runat="server" 
            ...
            <li id="liSelectPackage" runat="server" ><a
            ...
            <li id="li5" runat="server" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"
                href="#"><span class="glyphicon glyphicon-list-alt"></span> &nbsp;Report
                <%--<asp:Label ID="Label12" runat="server" meta:resourceKey="lblReport" Text="Report"></asp:Label>--%>
                ...
                <ul  class="dropdown-menu">
                    ...
                    <li><a href="../Report/SubjectWiseReportF.aspx" target="_self">
                        <asp:Label ID="Label3" runat="server" meta:resourceKey="lblSubjectWiseReport" Text="Subject wise exam result"></asp:Label>
                    </a></li>
            ...
            <span class="glyphicon glyphicon-phone-alt"></span>
               &nbsp;<asp:Label ID="Label11" runat="server" meta:resourceKey="lblContactUS" Text="Contact Us"></asp:Label>
            </a></li>
        </ul>
        </div>
        </div>
