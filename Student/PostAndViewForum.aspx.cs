...
public partial class Student_PostAndViewForum : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                Response.Redirect("../NewPublic/SwayamHomePage.aspx");
            }
            // BindPostGrid();
        }
    ...
    protected void btnReplyParent_Click(object sender, EventArgs e)
    {
        ...
        if (AppSessions.RoleID == 4)
            ...
            arrParameter.Add(new parameter("UserID", AppSessions.EmpolyeeID));
        ...
        arrParameter.Add(new parameter("UserName", AppSessions.UserName));
