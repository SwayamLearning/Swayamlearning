<%--<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Epathshala.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="TeacherDashboard.aspx.cs" Inherits="Teacher_TeacherDashboard"
        ...
        <ContentTemplate>
            <div class="tblDashboard">
                ...
                <div class="firstpanel">
                    ...
                    <%-- Start  --%>
                    <div id="dvteachercontentmain" runat="server" style="float: left; padding-bottom: 10px;
                        margin-left: 20px; border-radius: 1px; width: 49%; min-width: 470px;">
                    ...
                    <div id="Display" runat="server" meta:resourcekey="SelectBMSResource1" style="position: fixed;
                        top: 0px; left: 0px; width: 90%; height: 90%;">
                        <%--Header Area--%>
                ...
                <div class="firstpanel" id="dvreschedulemain" runat="server">
                    <div class="activitydiv activityleft" id="dvRescheduing" runat="server">
                        <div class="ActivityHeader">
                            <asp:Label ID="lblRescheduing" runat="server" Text="Approve Rescheduled Chapter Topic"
                                meta:resourcekey="lblRescheduingResource1"></asp:Label></div>
                        <div class="ActivityContent">
