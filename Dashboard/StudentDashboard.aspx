<%@ Page Title="" Language="C#" MasterPageFile="~/NewPublic/materialMaster.master" AutoEventWireup="true"
    CodeFile="StudentDashboard.aspx.cs" Inherits="Student_StudentDashboard" Culture="auto"
    ...
    <script type="text/javascript">
     ...
     //   debugger;
        ...
        function onSubjectClicked(subjectID, subject) {
            ...
            //alert(subject);
            showLoader();
             document.getElementById('<%= lblsubjectname.ClientID %>').innerHTML = subject;
            //var subjectHeader = document.getElementById("subjectHeader");
         ...
         debugger;
           <%--if ($("#<%= btnShow.ClientID%>") != null) {
            ...
            if ((ext == ".mp4")||(ext==".swf")) {
                ...
                if(ext==".mp4")
                {  modalBody.innerHTML="<video  oncontextmenu=\"return false;\" style=\"margin:auto;\" id=\"myVideo\" width='65%' preload controls autoplay><source type='video/mp4' codecs='avc1.42E01E, mp4a.40.2' SRC=\"SecurityHandler.ashx?param1=" + id + "&param2="+fname+"&param3="+res+"&param4="+ext+"\" ></video>";
                }
                else
                {
   
                    modalBody.innerHTML= "<object id=\"myVideo\" style=\"height: 315px; width: 420px;\" align=\"middle\"> <param name=\"movie\" value='" + res + "'><embed src='" + res + "' width=\"420\" height=\"320\"> </embed></object>"
                        //"<embed  id=\"myVideo\" src='" + res + "' height=\"300px\" width=\"500px\" />"
                }
             ...
             //   alert( modalBody.innerHTML);
               ...
               //  }
                ...
                //change for textbook view
            } else if (ext == ".pdf") {
                modalTitle.innerHTML += " - (Textook)"
                var pdfurl = window.location.href.replace("Dashboard/StudentDashboard.aspx", "") + res.replace("../", ""); 
                modalBody.innerHTML = "<iframe id='myframe' width='100%' height='100%' src='" + pdfurl + "?embedded=true\" allowfullscreen='true'></iframe>";
                //modalBody.innerHTML = "<iframe id='myframe' width='100%' height='100%' src=\"http://docs.google.com/gview?url=" + pdfurl + "&embedded=true\" allowfullscreen='true'></iframe>";
            } else if (ext == ".Test") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="subjectContainer" class="container-fluid">
        <%--changed 2805-- --%>
        <div class="row bmsdet">
            <div class="col-12">
                <asp:Label ID="lblbmsdet" runat="server" CssClass="bmslabel">
        ...
        <div class="row">
            <style>
                ...
                .activity {
                    background: url(../App_Themes/Home/images/Gujarati.jpg) no-repeat 0 0;
                    border: 0;
                    height: 400px;
                    width: 300px;
                    margin-top:35px;
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3" style="cursor: pointer">
                <script type="text/javascript">
            ...
            <% } //foreach %>
             <%-- <div class="activity">
                      ...
                      <button type="button" class="btn btn-link" runat="server" onserverclick="btnactivity_Click" id="btnactivity">
                                        ગુજરાતી બારાખડી<br />
                                        <i class="fa fa-youtube-play" aria-hidden="true" style="font-size: 4em; margin-top:50px;"></i>
                       </button>--%>
                   <%-- <asp:Button ID="btnactivity" Visible="false" runat="server" OnClick="btnactivity_Click"  CssClass="btnactivity"/>--%>
              <%--  </div>--%>
        </div>
    ...
    <div id="chapters" class="container-fluid d-none">
          <h4 style="text-transform: none; color:#0f697a;font-weight: bold;margin-top:60px;">Subject:  <asp:Label ID="lblsubjectname" runat="server"></asp:Label></h4>
        <%--Search--%>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="close" id="btnclose" data-dismiss="modal" onclick="closemodal">&times;</button>
                </div>
            ...
            <div>
                ...
                <div class="tab-content">
                    ...
                    <div id="Expired_Package" class="tab-pane fade">
                        <div class="GridTitle" style="visibility: hidden; display: none;">
                            <asp:Label runat="server" Text="Expired Packages"></asp:Label>
                        </div>
