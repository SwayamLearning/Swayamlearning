...
public partial class Report_SubjectwiseSchoolPerformanceReport : System.Web.UI.Page
{
    ...
    private void FillSubjectList()
    {
        ...
        dt = SchoolBLogic.BAL_SelectSubjectList("select [SYS_Subject].SubjectID , [SYS_Subject].Subject  from [SYS_Subject] where [SYS_Subject].SubjectID in(SELECT  distinct SubjectID FROM [vw_YearWiseSubjectWiseSchoolPerformance])");
