<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="SubjectwiseSchoolPerformanceReport.aspx.cs"
    Inherits="Report_SubjectwiseSchoolPerformanceReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container" style="margin-top: -50px;">
        <div class="row" style="background: #72abb5; color: White; height: 50px;">
            <div class="col-100">
                <asp:Label ID="Label2" runat="server" Text="Subjectwise School Performance Report"></asp:Label>
            </div>
        </div>
        <div class="row">
            <div class="col-100">
                <asp:UpdatePanel runat="server" ID="upTopics" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-25">
                                <asp:Label ID="lblsubject" runat="server" Text="Subject:" CssClass="textlabel"></asp:Label>
                            </div>
                            <div class="col-25">
                                <asp1:DropDownCheckBoxes ID="ddlsubject" runat="server" AddJQueryReference="True"
                                    UseButtons="True" UseSelectAllNode="True" CssClass="ddCheckBoxes">
                                    <Texts SelectBoxCaption="Select subject " />
                                    <Style SelectBoxWidth="400" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="70" />
                                </asp1:DropDownCheckBoxes>
                            </div>
                        </div>
