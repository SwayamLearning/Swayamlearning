...
public partial class Report_StudentChapterwisePerformanceReport : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
		...
		if (!IsPostBack)
		{
            ...
            Int32 StudentID = Convert.ToInt32(Session["StudentID"].ToString());
	...
	protected void btnreport_Click(object sender, EventArgs e)
	{
        ...
        Int32 SubjectID = Convert.ToInt32(ddlsubject.SelectedValue);
	...
	private  void GetReportdata(Int32 studentid, Int32 subjectid)
	{
		...
		try
		{
			...
			if (dsResult.Tables[0].Rows.Count > 0)
			{
				...
				for (int i = 0; i < count; i++)
				{
					...
					Int32 examid = Convert.ToInt32(dsResult.Tables[0].Rows[i]["ExamID"]);
	...
	public static string GetResultsByExamid(Int32 ExamId)
	{
    ...
    [WebMethod]
    public static List<object> GetPerformanceChartdata(Int32 subjectid)
    {
        ...
        try
        {
            ...
            //int subjectid = 1;
            Int32 studentid = Convert.ToInt32(AppSessions.StudentID);
            Int32 bmsid = Convert.ToInt32(AppSessions.BMSID);
