...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row" style="margin-top:70px;margin-left:180px;">
        ...
        <div class="col-12 col-sm-4 col-md-4 col-lg-3" align="center">
        ...
        <div class="col-12 col-sm-8 col-md-8 col-lg-9" align="center">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    ...
                    <asp:HyperLink runat="server" class="nav-link active" id="pillshometab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true" meta:resourcekey="hlReport">Report</asp:HyperLink>
                </li>
                <li class="nav-item">
                    ...
                    <asp:HyperLink class="nav-link" id="pillsprofiletab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false" runat="server" meta:resourcekey="hlChart">Chart</asp:HyperLink>
                </li>
            </ul>
        </div>
