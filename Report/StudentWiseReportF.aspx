<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="StudentWiseReportF.aspx.cs" Inherits="Report_StudentWiseReportF"
                ...
                <div class="tblDashboard">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-70">
                                                <asp:TextBox ID="txttodate" runat="server" meta:resourcekey="txttodateResource1"
                                                    CssClass="textBoxCls"></asp:TextBox>
                                                <%--<asp:ImageButton ID="ibtnToDate" runat="server"
                    ...
                    <div class="sidepanel1">
                        <div class="activitydivside1">
                            <div class="ActivityHeader">
                                <div class="row" style="background: #72abb5; color: White; height: 50px;" runat="server"
                                    visible="false" id="lblTitleSecond">
                                    <div class="col-100">
                                        <asp:Label ID="lblTitleSecond1" runat="server" Text="Subject wise result report"
                                            Visible="true" meta:resourcekey="lblTitleSecondResource1"></asp:Label>
                                    </div>
                                </div>
                                <div class="row" style="background: #72abb5; color: White; height: 50px;" runat="server"
                                    visible="false" id="lblTitleThird">
                                    <div class="col-100">
                                        <asp:Label ID="lblTitleThird1" runat="server" Text="All exam result report of Subject"
                                            Visible="true" meta:resourcekey="lblTitleThirdResource1"></asp:Label>
                                    </div>
                                </div>
                            </div>
